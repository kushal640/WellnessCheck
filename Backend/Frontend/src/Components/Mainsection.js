                  ...
                  <div className="container d-flex justify-content-center ">
                    <div className="col-10 book">
                      <div className="container">
                        <form action="/survey">
                          <div className="row  ">
                            <h2><center>Book an apointment</center></h2>
                            <p>
                              Booking an appointment with us is quick and easy. Take the first step towards prioritizing your health and well-being by scheduling a convenient time for your comprehensive checkup. Don't delay any longer – reserve your appointment now and embark on a proactive journey towards a healthier you.
                            </p>
                          </div>
